...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| valid | 610 | 20 | 30,500 | 0 | 0.000000 | 2,073 | 0 | 20.00 | 30163.41 |
| test | 610 | 24 | 30,500 | 0 | 0.000000 | 2,054 | 0 | 20.00 | 25456.56 |

## 해석

이 평가는 teacher-forcing token accuracy가 아니라 실제 추천 ranking 품질을 봅니다.
모델 logits에 STATIC-style constrained decoding mask를 적용해 존재하는 Semantic ID만 생성한 뒤 item_id로 복원하고, baseline과 같은 Recall/NDCG/MRR 기준으로 비교합니다.
